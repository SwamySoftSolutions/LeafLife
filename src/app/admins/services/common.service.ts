...
export class CommonService {
  ...
  profileMenu: ProMenu[] = [
    ...
    {
      id: 1, menuName: 'Profile', icon: 'fa fa-dashboard', url: './profile/', hide: false
    },
    {
      id: 2, menuName: 'Institute Registration', icon: 'fa fa-dashboard', url: './institute-registration', hide: false
    },
    {
      id: 3, menuName: 'Billing', icon: 'fa fa-dashboard', url: './billing', hide: false
    },
    {
      id: 4, menuName: 'Change Password', icon: 'fa fa-dashboard', url: './change-password', hide: false
    },
    {
      id: 5, menuName: 'Help', icon: 'fa fa-dashboard', url: './help', hide: false
    },
    {
      id: 6, menuName: 'Terms & Conditions', icon: 'fa fa-dashboard', url: './terms-conditions', hide: false
    },
    {
      id: 7, menuName: 'Privacy Policy', icon: 'fa fa-dashboard', url: './privacy-policy', hide: false
    },
    {
      id: 8, menuName: 'Logout', icon: 'fa fa-dashboard', url: './logout', hide: false
    }
  ];
  inst_menu: ProMenu[] = [
    {
    ...
    {
      id: 2, menuName: 'Profile', icon: 'fa fa-dashboard', url: './institute-edit', hide: false
    },
    {
      id: 3, menuName: 'Faculty', icon: 'fa fa-dashboard', url: './faculty/', hide: false
    },
    {
      id: 4, menuName: 'Courses', icon: 'fa fa-dashboard', url: './course/', hide: false
    },
    {
      id: 5, menuName: 'Batches & Demos', icon: 'fa fa-dashboard', url: './batches/', hide: false
    },
    {
      id: 6, menuName: 'Gallery', icon: 'fa fa-dashboard', url: './add-photos', hide: false
    }
  ]
  hostel_menu: Menu[] = [
    /*
